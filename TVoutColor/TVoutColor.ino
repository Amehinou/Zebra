...
void loop() 
{
   ...
   //========================================================================= TXT Vram
    ...
    if((curkey >=7) && (curkey <= 132) &&  (setVramMode == 0) && (setColorMode == 0) && (setColorAdvanceMode == 0) && (setColorAdvanceFullscreenMode == 0) && (setColorAdvanceSigMode == 0) ){
      switch(curkey){
      case 0x80:Ini_PT_TXT();break;
      case 0x81:Ini_PT_BLK( );break;
      case 0x82:Ini_PT_FSC();break;
      case 0x83:objCSL.clear_screen();objCSL.set_cursor(0,0);break;
