echo "STEP 1 - compile MONITOR"
 cd ./Zebra_Software_zMUSIC_inROM
 make
echo "=============================="

 wc -c zMusic.bin | awk '{printf "The Rom Address: %x",(49152-$1)}' 
echo ""
echo "=============================="
...
echo "STEP 3 - make Rom "
 ...
 cat ./Zebra_Software_zMUSIC_inROM/zMusic.bin ./Zebra_Software_MSBASIC_inROM/msbasic/tmp/zebra_msbasic.bin ./Zebra_Software_MONITOR_inROM/zebra_monitor.bin ./Zebra_Software_KRUSADER_inROM/KRUSADER_inRom.bin > ./zebra.bin
