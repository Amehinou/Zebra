...
LNMSZ	=$03
LBLSZ	=$02		; labels are up to 6 characters    LBLSZ	=$06
...
MNE	=$07		; mnemonic starts here
ARGS	=$0B		; arguments start here
COMM    =$19		; comments start here
...
DSMBL	
	LDA #$05	; Count for 20 instruction dsmbly
	STA COUNT
