...
LNMSZ	=$03
LBLSZ	=$03		; labels are up to 6 characters    LBLSZ	=$06  ==============================================================labels
...
MNE	=$08		; mnemonic starts here    ======================================================
ARGS	=$0C		; arguments start here
COMM    =$1A		; comments start here
...
DSMBL	
	LDA #$04	; Count for 20 instruction dsmbly ====================================================================
	STA COUNT
.DSMBL2	JSR INSTDSP	; Disassemble and display instr.
	...
	; LDA KBD	; Now disassemble until key press
	; .if APPLE1
	; CMP #$00
	; BEQ .DSMBL2
	; .else
...
MOD8CHK         LDA     XAML          ;  If address MOD 8 = 0 start new line
	...
	.if APPLE1
; Apple 1 I/O values
KBD     =$8001		; Apple 1 Keyboard character read.
